...
class Dashboard_artikel_model {
    ...
    public function tambahDataArticle($data)
    {
        // Insert event data into the 'event' table
        $query = "INSERT INTO $this->table (title, content, publish_date, author_id, category_id)
                VALUES (:title, :content, :publish_date, :author_id, :category_id)";
        ...
        if (isset($_FILES['images'])) {
            ...
            foreach ($images['tmp_name'] as $key => $tmp_name) {
                ...
                if ($images['error'][$key] === UPLOAD_ERR_OK) {
                    ...
                    $upload_dir = 'C:/xampp/htdocs/artikel/public/images/'; // Change the directory path as per your requirement
